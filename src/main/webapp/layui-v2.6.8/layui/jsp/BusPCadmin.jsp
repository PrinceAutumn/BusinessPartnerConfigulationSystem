...
<fieldset>
    <table background="images\e.jpg " width="933" height="412">
                        ...
                        <div class="box">
                            <div class="login-box">
                                <div class="login-title text-center">
                                    <h1>
                                        <small>智慧公交管理系统</small>
                                    </h1>
                                </div>
                                <td><label for="username">工  号：</label></td>
        ...
        <tr>
            ...
            <td><table>
                <tr>
                    <td><input type="submit" name="login" value="登   录" onClick="return validateLogin()"/></td>
                    <td><input type="reset" name="rs"    value=  "重   置"></td>
                    <td><input type="button" name="button" value="注  册" onclick="window.location.href='https://www.w3school.com.cn/jsref/event_onfocus.asp'"></td>
                </tr>
                </tr>
            </table>
            </td>
